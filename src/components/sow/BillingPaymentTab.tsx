...
export default function BillingPaymentTab({
  ...
  return (
    <section className="space-y-6">
      ...
      {/* Two-column layout: 60% Pricing Calculator, 40% Billing Information */}
      <div className="grid grid-cols-1 xl:grid-cols-5 gap-6">
        {/* Left Column - Pricing Calculator (60%) */}
        <div className="xl:col-span-3">
          <div className="bg-white shadow rounded-lg p-6">
            <h3 className="text-xl font-semibold text-gray-900 mb-6">Pricing Calculator</h3>
            <PricingCalculator formData={formData} setFormData={setFormData} />
          </div>
        </div>

        {/* Right Column - Billing Information (40%) */}
                          ...
                          {availableContacts.map((contact) => (
                            ...
                            >
                              ...
                              <div className="text-xs text-gray-600 mt-1">
                                <span className="inline-block px-1 py-0.5 bg-blue-100 text-blue-800 rounded-md text-xs font-medium mr-1">
                                  {contact.Title}
                                </span>
