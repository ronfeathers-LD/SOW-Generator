        ...
        {(formData.objectives?.avoma_transcription || (formData.objectives?.avoma_recordings && formData.objectives.avoma_recordings.length > 0)) && customerName && (
          <div className="flex justify-center mb-8">
            <Button
              ...
              className="px-8 py-4 text-lg rounded-lg shadow-lg transition-all duration-200 hover:scale-105"
            >
              {isAnalyzing ? 'Analyzing Transcriptions...' : 'Generate Objectives & Deliverables from Transcriptions'}
            </Button>
          </div>
        )}
