...
export default function PMHoursRequirementDisableApprovalOverlay({
  ...
  const handleReverse = async () => {
    if (!request || !reversalReason.trim()) return;
    ...
    try {
      ...
      if (response.ok) {
        ...
        const data = await response.json();
        setError(data.error || 'Failed to reverse request');
      }
    } catch (error) {
      console.error('Error reversing request:', error);
      setError('Failed to reverse request');
    } finally {
      setIsSubmitting(false);
    }
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Reverse Action - Only for approved/rejected requests and admin users */}
          {request.status !== 'pending' && session?.user?.role === 'admin' && (
            <div className="border-t border-gray-200 pt-6">
              <h3 className="font-medium text-gray-900 mb-4">Reverse Decision</h3>
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-2 text-sm text-yellow-700">
                      <p>
                        Reversing this request will set it back to pending status and revert any SOW changes.
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Please explain why this request is being reversed..."
                    required
                  />
                </div>
                <button
                ...
                >
                  ...
                  {isSubmitting ? 'Reversing...' : 'Reverse Request'}
                </button>
              </div>
            </div>
          )}
