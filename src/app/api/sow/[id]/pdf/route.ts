...
export async function POST(
  ...
  try {
    ...
    const transformedData = {
      ...
      client_roles: (sowData.roles && typeof sowData.roles === 'object' && !Array.isArray(sowData.roles)) ? sowData.roles.client_roles || '' : sowData.client_roles || '',
      pricing_roles: sowData.pricing_roles || '',
      pricing_total: (sowData.pricing_roles && typeof sowData.pricing_roles === 'object' && !Array.isArray(sowData.pricing_roles)) ? sowData.pricing_roles.total_amount || 0 : 0,
      pricing_subtotal: (sowData.pricing_roles && typeof sowData.pricing_roles === 'object' && !Array.isArray(sowData.pricing_roles)) ? sowData.pricing_roles.subtotal || 0 : 0,
      pricing_discount: (sowData.pricing_roles && typeof sowData.pricing_roles === 'object' && !Array.isArray(sowData.pricing_roles)) ? sowData.pricing_roles.discount_total || 0 : 0,
      pricing_discount_type: (sowData.pricing_roles && typeof sowData.pricing_roles === 'object' && !Array.isArray(sowData.pricing_roles)) ? sowData.pricing_roles.discount_type || 'none' : 'none',
